...
export function CmsPagesEditor() {
  ...
  const choosePage = async (page: AdminCmsPage) => {
    ...
    setBusy(true);
    try {
      const nextSections = await fetchAdminCmsPageSections(page.id);
