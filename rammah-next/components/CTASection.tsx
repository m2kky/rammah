...
export default function CTASection({ section }: { section?: PublicPageSection | null }) {
  ...
  return (
    <section id="contact" ref={ref} className="w-full bg-black">
      {/* Full-screen CTA panel */}
      <div
        className="relative flex min-h-[100dvh] w-full flex-col items-center justify-center overflow-hidden bg-[#0F3B46] px-6 py-24 transition-all duration-[1300ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:px-16"
        style={{
          clipPath: inView
      ...
      {/* Subscribe panel */}
      <div
        className={`flex min-h-[92dvh] w-full flex-col items-center justify-center gap-5 bg-white px-6 py-20 transition-all duration-[1150ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:gap-6 md:px-16 ${
