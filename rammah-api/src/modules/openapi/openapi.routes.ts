...
const adminPaths: Record<string, PathSpec> = {
  ...
  "/admin/offerings/{id}/prices": { get: operation({ summary: "List offering country price groups and metadata", tags: ["Admin Offerings"], secured: true }), post: operation({ summary: "Create an offering country price group", tags: ["Admin Offerings"], secured: true, status: httpStatus.created }) },
  "/admin/offerings/{id}/prices/{priceId}": { patch: operation({ summary: "Update an offering country price group", tags: ["Admin Offerings"], secured: true }), delete: operation({ summary: "Archive an offering country price group", tags: ["Admin Offerings"], secured: true, noContent: true }) },
